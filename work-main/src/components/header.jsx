              ...
              <Grid
                    ...
                    >
                        <Grid item xs={8} sm={8} md={8} lg={8}>
                              <motion.div className="intro-text" transition={{ opacity: { duration: 3 },translateY:{ duration:3  } }} animate={{ opacity: shouldShowActions ? 1 : 0,translateY:"250px" }} initial={{ opacity:0,translateY:"150px"  }}>
